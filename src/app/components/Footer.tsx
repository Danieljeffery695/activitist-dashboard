...
export default function Footer() {
    return (
        // Footer start here
        <footer className="footer w-full border-t-2 border-t-slate-300 bg-white overflow-hidden relative 320:h-p-900 md:w-p-400">
            ...
            <div className="w-full h-full flex md:items-center md:justify-between pt-10 320:flex-col md:flex-row lg:justify-center">
                ...
                <div className="h-full z-10 410:pl-10 md:flex-1 md:flex md:flex-col md:items-center md:pl-0">
                ...
                <div className="h-full z-10 410:pl-10 md:flex-1 lg:flex lg:flex-col lg:items-center md:pl-0">
                    <div className="h-20 w-full lg:text-center">
                    ...
                    <form action="" className="flex flex-col">
                        ...
                        <button className="bg-green-500 w-28 410:pl-5 410:text-white h-10 md:ml-2 md:mt-2 rounded-2xl shadow-md shadow-black cursor-pointer">Subscribe</button>
                    </form>
                </div>
            </div>
        </footer>
