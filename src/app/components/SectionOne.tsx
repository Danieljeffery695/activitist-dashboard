...
import { karla, cormorant, epunda, roboto, dancing } from "../layout";

export default function SectionOne() {
  return (
    // Section one start here

    <section className="320:h-1100 320:overflow-hidden 370:h-1200 w-full bg-white section-first text-center">
      ...
      <div className="320:h-800 320:grid 320:grid-rows-2 370:h-900 w-full md:h-full mt-32 md:flex">
        <div className="320:m-auto 320:w-35 320:h-350 410:w-[190px] 540:w-[240px] md:w-80 md:h-96 bg-slate-500 mx-2 flex-1 rounded-lg">
          ...
          <div className="md:w-full lg:w-1/2 m-auto">
            <h3 className={`md:text-3xl ${cormorant.className} md:text-nowrap my-2 font-extrabold`}>Default Opt-In</h3>
        ...
        <div className="320:m-auto 320:w-35 320:h-350 410:w-[190px] 540:w-[240px] md:w-80 md:h-96 bg-slate-500 mx-2  flex-1 rounded-lg">
          ...
          <div className="md:w-full lg:w-1/2 m-auto">
            <h2 className={`md:text-3xl ${cormorant.className} md:text-nowrap my-2 font-extrabold`}>Reward Experience</h2>
            <p className={`text-lg ${epunda.className}`}>Users receive valuable in-app rewards in exchange for mining online.</p>
          </div>
        </div>
        <div className="320:mx-auto 320:mt-28 320:w-78 320:h-200 320:col-span-2 370:w-[350px] 370:h-300 410:w-p-400 410:h-60 540:w-[520px] 540:h-250 md:w-80 md:h-96 bg-slate-500 mx-2 flex-1 rounded-lg">
          <div className="320:h-100 w-full md:h-52">
          ...
          <div className="md:w-full lg:w-1/2 m-auto">
            <h2 className={`md:text-3xl ${cormorant.className} md:text-nowrap my-2 font-extrabold`}>Flexible Opt-Out</h2>
