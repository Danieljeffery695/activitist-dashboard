    ...
    return (
        <section className="320:h-950 370:h-1000 410:w-overfull 410:h-1100 540:h-1200 w-full overflow-hidden relative section-third mt-1.5">
            <div className="w-full section-third-div h-[90%] rounded-tl-[130px] relative md:rotate-9 320:rotate-7 bg-white overflow-hidden -mb-11 320:right-[-5%] 320:top-[8%] 320:z-10 410:right-[-2%]">
                <div className="flex w-full h-full md:-rotate-9 320:flex-col 320:-rotate-7">

                    <div className="md:flex-2 lg:flex-1 320:w-4/5 320:m-auto h-full relative">
                    ...
                    <div className="md:flex-3 lg:flex-1 flex ml-6 flex-col justify-center">
                        ...
                        <ul className="md:w-10/12 320:w-4/5 320:mx-auto bg-red-500">
                            <li className={`${cormorant.className} 320:mt-2.5 410:mt-5 410:text-small-17`}><span className="cursor-pointer">&#9737;</span> Smart contracts that work such as Lightning Network</li>
                            <li className={`${cormorant.className} 320:mt-2.5 410:mt-5 410:text-small-17`}><span className="cursor-pointer">&#9737;</span> Proof-of-stake (Pos) consensus Cross-chain atomic swaps</li>
                            <li className={`${cormorant.className} 320:mt-2.5 410:mt-5 410:text-small-17`}><span className="cursor-pointer">&#9737;</span> Connectivity across payments networks</li>
