...
export default function SectionThree() {
    ...
    return (
        <section className="320:h-p-950 370:h-p-1000 410:w-p-overfull 410:h-p-1100 w-full overflow-hidden section-third mt-1.5">
                ...
                <div className="flex w-full h-full md:-rotate-9 320:-rotate-7">
                    ...
                    <div className="md:flex-3 lg:flex-1 flex ml-6 flex-col justify-center">
                        <div className="md:w-10/12 320:text-center">
                            ...
                            <h1 className="md:text-3xl 320:w-p-250 320:text-[22px] 320:m-auto 370:text-small-25 410:w-[310px] 410:text-small-27">Magical Technology to Make Your Money Secure</h1>
                            <p className="md:text-2xl 320:w-p-250 320:text-[17px] 320:pt-2.5 320:m-auto 370:text-small-18 410:w-[310px] 410:text-small-19">Create a tradeable digital token that can be used as a currency, a representation of an asset, a virtual share, a proof of membership anything at all</p>
                        </div>
