...
export default function SectionTwo() {
    return (
        ...
        <section className="320:w-p-1350 370:h-[1350px] 410:w-full py-4 section-second">
            <h3 className="text-2xl text-white md:ml-9">02 --------- Why Activities</h3>
            <h1 className="text-3xl md:ml-9">The Difference Between Us and Other Competitors</h1>
